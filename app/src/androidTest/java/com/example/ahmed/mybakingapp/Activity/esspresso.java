        ...
        ViewInteraction recyclerView9 = onView(
                allOf(withId(R.id.step_Recycle),
                        childAtPosition(
                                withClassName(is("android.widget.LinearLayout")),
                                1)));
        recyclerView9.perform(actionOnItemAtPosition(6, click()));
        ...
        ViewInteraction recyclerView11 = onView(
                allOf(withId(R.id.ingred_Recycle),
                        childAtPosition(
                                withId(R.id.activity_ingred),
                                1)));
        recyclerView11.perform(actionOnItemAtPosition(1, click()));
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.next_step), withText("Next"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView.check(matches(withText("Next")));
